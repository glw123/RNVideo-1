...
export default class HomeDetail extends PureComponent {
    ...
    render(){
        // Alert.alert(this.state.params.thumbnail+"xiaxia"+this.state.params.url);
           ...
           this.state.params?
            <View style={styles.container} onLayout={this._onLayoutChange}>
                <VideoPlayer
                    ...
                    videoURL={"http://b.zyyule.top/XResource/20190819/file_359_5d5a18e21ac12.mov"}
                    videoTitle={this.state.params.title}
                    videoCover={"http://b.zyyule.top/XResource/20190819/file_359_5d5a18eb7ac2c.jpg"}
